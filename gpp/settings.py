...
if PRODUCTION_DOMAINS:
    CORS_ALLOWED_ORIGINS.extend([domain.strip() for domain in PRODUCTION_DOMAINS if domain.strip()])
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': str(LOGS_DIR / 'gatepasspro.log'),
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=15),  # Good for security
    'REFRESH_TOKEN_LIFETIME': timedelta(days=1),     # Convenient for users
